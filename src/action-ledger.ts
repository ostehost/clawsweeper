...
export const ACTION_EVENT_TYPES = {
  ...
  evidenceServiceRequest: "evidence.service_request",
  evidenceServiceDeploy: "evidence.service_deploy",
  evidenceServiceRollback: "evidence.service_rollback",
...
export const ACTION_EVENT_FAMILIES = {
  ...
  evidence: [
    ...
    ACTION_EVENT_TYPES.evidenceServiceRequest,
    ACTION_EVENT_TYPES.evidenceServiceDeploy,
    ACTION_EVENT_TYPES.evidenceServiceRollback,
...
export const ACTION_EVENT_PHASE_TYPES = {
  ...
  evidenceServiceRequest: ACTION_EVENT_TYPES.evidenceServiceRequest,
  evidenceServiceDeploy: ACTION_EVENT_TYPES.evidenceServiceDeploy,
  evidenceServiceRollback: ACTION_EVENT_TYPES.evidenceServiceRollback,
